...
<input type="text" class="formcontrol @error('nama_departemen') is-invalid @enderror"
...
<input type="text" class="formcontrol @error('nama_manager') is-invalid @enderror" name="nama_manager"
...
<input type="number" class="formcontrol @error('jumlah_pegawai') is-invalid @enderror"
